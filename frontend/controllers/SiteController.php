        ...
        return [
            'access' => [
                ...
                'denyCallback' => function ($rule, $action) {
                    $this->redirect(['site/register-login', 'controller' => \Yii::$app->controller->id]);
                },
            ],
            'verbs' => [
    ...
    public function actionRegisterLogin()
    {
        ...
        $login_form = new LoginForm();
         if ($model->load(Yii::$app->request->post())) 
            ...
            if($user= User::find()->where(['username'=>$model->username])->andWhere(['=','status',10])->one())
            {
        ...
        return $this->render('register_login', [
            'model' => $model,
        ]);
    }
